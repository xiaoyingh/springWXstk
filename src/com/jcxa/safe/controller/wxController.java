...
public class wxController {
	...
	//判断用户的手机号是否为空
	@RequestMapping(value="/getTephone")
	@ResponseBody
	public String  getTephone(@RequestParam(value = "ID", required = false) Integer ID) {
					System.out.println(vipService.getTephone(ID)+"手机号码是否为空");
				if(vipService.getTephone(ID)){
					return "exist";
				}else{
					return "no";
				}
