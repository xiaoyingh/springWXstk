...
public class paywxController {
	...
	protected Logger log = Logger.getLogger(paywxController.class);
...
//						String product_id = "";
						...
						System.out.println(title+"0000000000000000000000000000000000000000000000000000000");
						System.out.println(ur+"111111111111111111111111111111111111111111111111111111");
						System.out.println(pi+"222222222222222222222222222222222222222222222222222222");
						...
						try {
							response.sendRedirect("views/wxorder.jsp?appid="+appid2+"&timeStamp="+timestamp+"&nonceStr="+nonceStr2+"&package="+packages+"&sign="+finalsign+"&titles="+title+"&ur="+ur+"&pi="+pi);
						} catch (IOException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
