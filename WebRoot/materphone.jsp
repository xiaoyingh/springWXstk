...
<div class="wx_wrap">
	<div class="phone_con">
			<form action="addphone" method="post" id="reg-form" name="user">
			<ul>
				<li class="phone_text">
					<div>
				...
				<li class="phone_yzm">
					<div>
						<input type="number" name="" id="CheckCode" value="" class="code_yzm" placeholder="请输入验证码" onchange="checkrandomSpan();"/>
					</div>
